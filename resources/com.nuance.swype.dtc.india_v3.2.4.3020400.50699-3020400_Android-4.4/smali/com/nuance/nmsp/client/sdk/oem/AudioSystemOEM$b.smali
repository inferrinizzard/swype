...
.method public final a(Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$StopCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$EndOfSpeechCallback;Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "Could not stop audioRecord."
...
.method public final a(ZLcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$AudioCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$StopCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$ErrorCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$StartOfSpeechCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$EndOfSpeechCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$EndPointerStartedCallback;Lcom/nuance/nmsp/client/sdk/common/oem/api/AudioSystem$EndPointerStoppedCallback;Ljava/lang/Object;)V
    ...
    const-string/jumbo v4, "encodeInitSpeex failed with code:"
    ...
    const-string/jumbo v2, "AudioRecord object has not been initialized correctly. One or several parameters used to create it must be wrong."
    ...
    const-string/jumbo v2, "Could not instanciate AudioRecord object."
    ...
    const-string/jumbo v4, "Call to AudioRecord.setPositionNotificationPeriod() failed with code:"
    ...
    const-string/jumbo v4, "Call to AudioRecord.read() failed with code:"
    ...
    const-string/jumbo v2, "Call to AudioRecord.startRecording() failed."
...
.method public final handleMessage(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "Call to AudioRecord.read() failed with code: "
    ...
    const-string/jumbo v1, "AudioRecorder has no audio."
    ...
    const-string/jumbo v2, "Call to encodeSpeex() failed with code: "
    ...
    const-string/jumbo v8, "RECORDING: Sample #"
    ...
    const-string/jumbo v5, " shorts from recorder, sending "
    ...
    const-string/jumbo v5, " SPEEX vocoded bytes. "
    ...
    const-string/jumbo v4, "ENDPOINTING SPEECH_END"
    ...
    const-string/jumbo v4, "ENDPOINTING SPEECH_START"
    ...
    const-string/jumbo v5, "RECORDING: Sample #"
    ...
    const-string/jumbo v5, " bytes from recorder."
