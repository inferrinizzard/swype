...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        this.mCalled = true;
        Activity hostActivity = this.mHost == null ? null : this.mHost.mActivity;
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mLoaderManager != null) {
            ...
            this.mLoaderManager.dump(prefix + ThemeManager.NO_PRICE, fd, writer, args);
        }
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            writer.println("Child " + this.mChildFragmentManager + ":");
            this.mChildFragmentManager.dump(prefix + ThemeManager.NO_PRICE, fd, writer, args);
        }
    }
    ...
    public void performPause() {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.moveToState$2563266(4);
        }
        this.mState = 4;
        this.mCalled = false;
        onPause();
    ...
    public void performDestroyView() {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.moveToState$2563266(1);
        }
        this.mState = 1;
        this.mCalled = false;
        onDestroyView();
