...
public final class Utility {
    ...
    public static class FetchedAppSettings {
        ...
        private FetchedAppSettings(boolean supportsImplicitLogging, String nuxContent, boolean nuxEnabled, boolean customTabsEnabled, int sessionTimeoutInSeconds, Map<String, Map<String, DialogFeatureConfig>> dialogConfigMap, boolean automaticLoggingEnabled, FacebookRequestErrorClassification errorClassification) {
    ...
    public static class DialogFeatureConfig {
        ...
        public static DialogFeatureConfig parseDialogConfig(JSONObject dialogConfigJSON) {
            ...
            int[] featureVersionSpec = parseVersionSpec(dialogConfigJSON.optJSONArray(Utility.DIALOG_CONFIG_VERSIONS_KEY));
    ...
    public static int[] intersectRanges(int[] range1, int[] range2) {
        if (range1 != null) {
            ...
            while (true) {
                ...
                int newRangeLower = Integers.STATUS_SUCCESS;
    ...
    public static String readStreamToString(InputStream inputStream) throws IOException {
        ...
        try {
            ...
            char[] buffer = new char[HardKeyboardManager.META_SELECTING];
            while (true) {
    ...
    public static void logd(String tag, Exception e) {
        if (FacebookSdk.isDebugEnabled() && tag != null && e != null) {
            new StringBuilder().append(e.getClass().getSimpleName()).append(": ").append(e.getMessage());
        }
    }
    ...
    public static void setAppEventExtendedDeviceInfoParameters(JSONObject params, Context appContext) throws JSONException {
        ...
        extraInfoArray.put(locale.getLanguage() + Document.ID_SEPARATOR + locale.getCountry());
    ...
    private static int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] cpuFiles = new File("/sys/devices/system/cpu/").listFiles(new FilenameFilter() { // from class: com.facebook.internal.Utility.3
