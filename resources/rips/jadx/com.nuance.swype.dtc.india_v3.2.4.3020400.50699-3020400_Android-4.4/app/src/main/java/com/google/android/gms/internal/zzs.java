...
public class zzs {
    ...
    public static class zza {
        ...
        private final List<C0108zza> zzbk = new ArrayList();
        ...
        public static class C0108zza {
            ...
            public C0108zza(String str, long j, long j2) {
                this.name = str;
                this.zzbm = j;
                this.time = j2;
            }
        ...
        public final synchronized void zza(String str, long j) {
            ...
            this.zzbk.add(new C0108zza(str, j, SystemClock.elapsedRealtime()));
        }

        public final synchronized void zzd(String str) {
            this.zzbl = true;
            long j = this.zzbk.size() == 0 ? 0L : this.zzbk.get(this.zzbk.size() - 1).time - this.zzbk.get(0).time;
            if (j > 0) {
                long j2 = this.zzbk.get(0).time;
                zzs.zzb("(%-4d ms) %s", Long.valueOf(j), str);
                long j3 = j2;
                for (C0108zza c0108zza : this.zzbk) {
                    long j4 = c0108zza.time;
                    zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j4 - j3), Long.valueOf(c0108zza.zzbm), c0108zza.name);
                    j3 = j4;
                }
            }
        }
