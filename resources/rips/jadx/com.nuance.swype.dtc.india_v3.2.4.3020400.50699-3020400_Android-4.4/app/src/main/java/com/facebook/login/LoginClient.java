...
public class LoginClient implements Parcelable {
    public static final Parcelable.Creator<LoginClient> CREATOR = new Parcelable.Creator() { // from class: com.facebook.login.LoginClient.1
        ...
        @Override // android.os.Parcelable.Creator
        public final LoginClient[] newArray(int size) {
    ...
    public static class Request implements Parcelable {
        public static final Parcelable.Creator<Request> CREATOR = new Parcelable.Creator() { // from class: com.facebook.login.LoginClient.Request.1
            ...
            @Override // android.os.Parcelable.Creator
            public final Request[] newArray(int size) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public void setDeviceRedirectUriString(String deviceRedirectUriString) {
            this.deviceRedirectUriString = deviceRedirectUriString;
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public boolean hasPublishPermission() {
            Iterator i$ = this.permissions.iterator();
            while (i$.hasNext()) {
                if (LoginManager.isPublishPermission(i$.next())) {
                    return true;
                }
            }
            return false;
