...
public class FacebookTimeSpentData implements Serializable {
    ...
    private static final long[] INACTIVE_SECONDS_QUANTA = {APP_ACTIVATE_SUPPRESSION_PERIOD_IN_MILLISECONDS, 900000, 1800000, TimeConversion.MILLIS_IN_HOUR, 21600000, 43200000, TimeConversion.MILLIS_IN_DAY, 172800000, 259200000, 604800000, 1209600000, 1814400000, 2419200000L, 5184000000L, 7776000000L, 10368000000L, 12960000000L, 15552000000L, 31536000000L};
