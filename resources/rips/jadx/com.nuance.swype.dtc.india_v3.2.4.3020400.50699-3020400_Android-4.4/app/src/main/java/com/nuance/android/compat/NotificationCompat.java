...
public class NotificationCompat {
    ...
    static class NotificationCompatImplBase implements NotificationCompatImpl {
        ...
        @Override // com.nuance.android.compat.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b) {
            Notification result = b.mNotification;
            Notification ret = new Notification.Builder(b.mContext).setWhen(result.when).setContentTitle(b.mContentTitle).setContentText(b.mContentText).setContentIntent(b.mContentIntent).build();
            if (b.mPriority > 0) {
                ret.flags |= 128;
            }
            return ret;
    ...
    static class NotificationCompatImplJellybean implements NotificationCompatImpl {
        ...
        public Notification build(Builder b) {
            ...
            Iterator<Action> it = b.mActions.iterator();
            while (it.hasNext()) {
