...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        /* loaded from: classes.dex */
        private static class C0029zza implements zzl {
            ...
            public final void zzb(AdResponseParcel adResponseParcel) throws RemoteException {
        ...
        public static zzl zzbd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C0029zza(iBinder) : (zzl) queryLocalInterface;
        }
