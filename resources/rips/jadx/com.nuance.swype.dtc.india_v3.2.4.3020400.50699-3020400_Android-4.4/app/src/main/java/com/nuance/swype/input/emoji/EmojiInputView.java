...
public class EmojiInputView extends LinearLayout implements DragHelper.DragVisualizer {
    private static final LogManager.Log log = LogManager.getLog("EmojiInputView");
