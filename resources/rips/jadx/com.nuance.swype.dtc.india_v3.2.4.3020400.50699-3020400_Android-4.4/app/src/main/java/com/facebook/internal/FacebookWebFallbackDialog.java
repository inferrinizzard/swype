...
public class FacebookWebFallbackDialog extends WebDialog {
    ...
    protected Bundle parseResponseUri(String url) {
        ...
        if (!Utility.isNullOrEmpty(bridgeArgsJSONString)) {
            try {
                Bundle bridgeArgs = BundleJSONConverter.convertToBundle(new JSONObject(bridgeArgsJSONString));
        ...
        if (!Utility.isNullOrEmpty(methodResultsJSONString)) {
            ...
            try {
                Bundle methodResults = BundleJSONConverter.convertToBundle(new JSONObject(methodResultsJSONString));
