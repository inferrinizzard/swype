...
public interface zzee extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzee {
        ...
        /* renamed from: com.google.android.gms.internal.zzee$zza$zza, reason: collision with other inner class name */
        /* loaded from: classes.dex */
        public static class C0075zza implements zzee {
            private IBinder zzahn;

            public C0075zza(IBinder iBinder) {
                this.zzahn = iBinder;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzdz.zza.zzad(parcel.readStrongBinder()));
