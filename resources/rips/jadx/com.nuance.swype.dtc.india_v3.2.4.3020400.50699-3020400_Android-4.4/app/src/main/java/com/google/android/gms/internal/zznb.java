...
public interface zznb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznb {
        ...
        /* loaded from: classes.dex */
        private static class C0102zza implements zznb {
            ...
            @Override // com.google.android.gms.internal.zznb
            public final void zzfn(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.auth.api.internal.IAuthCallbacks");
        ...
        public static zznb zzcg(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.internal.IAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznb)) ? new C0102zza(iBinder) : (zznb) queryLocalInterface;
        }
    ...
    void zzfn(String str) throws RemoteException;
}
