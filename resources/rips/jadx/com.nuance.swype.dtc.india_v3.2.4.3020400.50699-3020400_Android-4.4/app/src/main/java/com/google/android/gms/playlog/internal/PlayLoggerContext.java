...
public class PlayLoggerContext extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        zza.zza$495264e0(this, parcel);
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(this.versionCode), this.packageName, Integer.valueOf(this.arq), Integer.valueOf(this.arr), this.arv, this.ars, this.art, Boolean.valueOf(this.aru), Boolean.valueOf(this.arw), Integer.valueOf(this.arx)});
    }
}
