        ...
        if (obj != null) {
            if (!(obj instanceof zzapv)) {
                ...
                if (obj instanceof String) {
                    ...
                    stringBuffer2.append("\"").append(zzia(str2)).append("\"");
            ...
            if (str != null) {
                stringBuffer2.append(stringBuffer).append(zzty(str)).append(" <\n");
                stringBuffer.append(ThemeManager.NO_PRICE);
            }
            Class<?> cls = obj.getClass();
            for (Field field : cls.getFields()) {
                int modifiers = field.getModifiers();
                String name = field.getName();
                if (!"cachedSize".equals(name) && (modifiers & 1) == 1 && (modifiers & 8) != 8 && !name.startsWith(Document.ID_SEPARATOR) && !name.endsWith(Document.ID_SEPARATOR)) {
