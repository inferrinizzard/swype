...
public interface zzgj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgj {
        ...
        /* loaded from: classes.dex */
        private static class C0083zza implements zzgj {
        ...
        public static zzgj zzaj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzgj)) ? new C0083zza(iBinder) : (zzgj) queryLocalInterface;
        }
