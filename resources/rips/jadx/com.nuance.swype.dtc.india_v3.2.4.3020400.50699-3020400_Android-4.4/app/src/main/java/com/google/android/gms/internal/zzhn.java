...
public interface zzhn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhn {
        ...
        /* loaded from: classes.dex */
        private static class C0092zza implements zzhn {
            ...
            public final String getProductId() throws RemoteException {
            ...
            @Override // com.google.android.gms.internal.zzhn
            public final void recordPlayBillingResolution(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
            ...
            @Override // com.google.android.gms.internal.zzhn
            public final void recordResolution(int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
        ...
        public static zzhn zzat(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhn)) ? new C0092zza(iBinder) : (zzhn) queryLocalInterface;
        }
