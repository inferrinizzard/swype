...
public interface zzaa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaa {
        ...
        /* loaded from: classes.dex */
        private static class C0010zza implements zzaa {
            ...
            public final IBinder zza(com.google.android.gms.dynamic.zzd zzdVar, int i) throws RemoteException {
        ...
        public static zzaa zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaa)) ? new C0010zza(iBinder) : (zzaa) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(zzd.zza.zzfc(parcel.readStrongBinder()), parcel.readInt());
