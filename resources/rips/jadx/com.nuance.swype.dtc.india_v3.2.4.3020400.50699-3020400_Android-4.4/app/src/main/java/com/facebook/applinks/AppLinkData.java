...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkFromServer(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        try {
            ...
            try {
                JSONObject jsonResponse = GraphRequest.newPostRequest(null, deferredApplinkUrlPath, deferredApplinkParams, null).executeAndWait().getJSONObject();
    ...
    private static AppLinkData createFromJson(String jsonString) {
        ...
        try {
            ...
            if (appLinkArgsJson.getJSONObject("bridge_args").getString(BRIDGE_ARGS_METHOD_KEY).equals("applink") && version.equals(MessageAPI.DELAYED_FROM)) {
                AppLinkData appLinkData = new AppLinkData();
