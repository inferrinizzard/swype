...
public interface zzed extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzed {
        ...
        /* loaded from: classes.dex */
        public static class C0074zza implements zzed {
            private IBinder zzahn;

            public C0074zza(IBinder iBinder) {
                this.zzahn = iBinder;
            }
            ...
            public final void zza(zzdz zzdzVar, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.IOnCustomClickListener");
                    obtain.writeStrongBinder(zzdzVar != null ? zzdzVar.asBinder() : null);
    ...
    void zza(zzdz zzdzVar, String str) throws RemoteException;
}
