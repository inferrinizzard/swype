...
public abstract class AbstractGoogleClient {
    ...
    public final BatchRequest batch(HttpRequestInitializer httpRequestInitializer) {
        ...
        batch.batchUrl = new GenericUrl(getRootUrl() + "batch");
        return batch;
    }
    ...
    public static abstract class Builder {
        ...
        public Builder(HttpTransport transport, String rootUrl, String servicePath, ObjectParser objectParser, HttpRequestInitializer httpRequestInitializer) {
            this.transport = (HttpTransport) com.google.api.client.repackaged.com.google.common.base.Preconditions.checkNotNull(transport);
