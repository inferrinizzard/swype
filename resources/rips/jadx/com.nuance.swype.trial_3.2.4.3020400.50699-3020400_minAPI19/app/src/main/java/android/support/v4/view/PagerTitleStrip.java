...
public class PagerTitleStrip extends ViewGroup {
    ...
    static class PagerTitleStripImplBase implements PagerTitleStripImpl {
        ...
        public final void setSingleLineAllCaps(TextView text) {
            text.setSingleLine();
        }
    }
    ...
    static class PagerTitleStripImplIcs implements PagerTitleStripImpl {
        ...
        @Override // android.support.v4.view.PagerTitleStrip.PagerTitleStripImpl
        public final void setSingleLineAllCaps(TextView text) {
            text.setTransformationMethod(new PagerTitleStripIcs.SingleLineAllCapsTransform(text.getContext()));
        }
    }
    ...
    public PagerTitleStrip(Context context, AttributeSet attrs) {
        ...
        this.mPageListener = new PageListener(this, (byte) 0);
    ...
    final void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int) (width * 0.8f)), Integers.STATUS_SUCCESS);
        int childHeight = (getHeight() - getPaddingTop()) - getPaddingBottom();
        int childHeightSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, childHeight), Integers.STATUS_SUCCESS);
    ...
    final void updateAdapter(PagerAdapter oldAdapter, PagerAdapter newAdapter) {
        if (oldAdapter != null) {
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        int currLeft = ((stripWidth - textPaddedRight) - ((int) (contentWidth * currOffset))) - halfCurrWidth;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(heightMeasureSpec) == 1073741824) {
            ...
            height = Math.max(getMinHeight(), textHeight + heightPadding);
        }
    ...
    public class PageListener extends DataSetObserver implements ViewPager.OnAdapterChangeListener, ViewPager.OnPageChangeListener {
        ...
        /* synthetic */ PageListener(PagerTitleStrip x0, byte b) {
            this();
        }
        ...
        public final void onAdapterChanged$49113dbb(PagerAdapter oldAdapter, PagerAdapter newAdapter) {
