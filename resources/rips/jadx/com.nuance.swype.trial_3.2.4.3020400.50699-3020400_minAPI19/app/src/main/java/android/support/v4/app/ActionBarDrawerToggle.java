...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private static class ActionBarDrawerToggleImplBase implements ActionBarDrawerToggleImpl {
        ...
        @Override // android.support.v4.app.ActionBarDrawerToggle.ActionBarDrawerToggleImpl
        public final Object setActionBarUpIndicator(Object info, Activity activity, Drawable themeImage, int contentDescRes) {
            return info;
        }

        @Override // android.support.v4.app.ActionBarDrawerToggle.ActionBarDrawerToggleImpl
        public final Object setActionBarDescription(Object info, Activity activity, int contentDescRes) {
            return info;
        }
    }
    ...
    static {
        ...
        if (version >= 18) {
            IMPL = new ActionBarDrawerToggleImplJellybeanMR2(b);
        } else if (version >= 11) {
            IMPL = new ActionBarDrawerToggleImplHC(b);
        } else {
            IMPL = new ActionBarDrawerToggleImplBase(b);
        }
    }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean animate, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
        ...
        this.mSlider = new SlideDrawable(this, this.mDrawerImage, (byte) 0);
        SlideDrawable slideDrawable = this.mSlider;
        slideDrawable.mOffset = animate ? TOGGLE_DRAWABLE_OFFSET : 0.0f;
    ...
    public void onDrawerSlide(View drawerView, float slideOffset) {
        float glyphOffset;
        float glyphOffset2 = this.mSlider.mPosition;
        if (slideOffset > 0.5f) {
    ...
    public class SlideDrawable extends InsetDrawable implements Drawable.Callback {
        ...
        /* synthetic */ SlideDrawable(ActionBarDrawerToggle x0, Drawable x1, byte b) {
            this(x1);
        }
