...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.measure(View.MeasureSpec.makeMeasureSpec(decorWidth, Integers.STATUS_SUCCESS), View.MeasureSpec.makeMeasureSpec(decorHeight, Integers.STATUS_SUCCESS));
