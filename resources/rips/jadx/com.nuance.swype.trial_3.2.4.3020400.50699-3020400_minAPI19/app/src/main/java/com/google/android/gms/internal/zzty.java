...
public interface zzty extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzty {
        ...
        /* renamed from: com.google.android.gms.internal.zzty$zza$zza, reason: collision with other inner class name */
        /* loaded from: classes.dex */
        private static class C0111zza implements zzty {
            ...
            @Override // com.google.android.gms.internal.zzty
            public final void init(com.google.android.gms.dynamic.zzd zzdVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.flags.IFlagProvider");
        ...
        public static zzty asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzty)) ? new C0111zza(iBinder) : (zzty) queryLocalInterface;
        }
