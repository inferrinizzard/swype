...
public interface zzdv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdv {
        ...
        /* loaded from: classes.dex */
        private static class C0069zza implements zzdv {
        ...
        public static zzdv zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdv)) ? new C0069zza(iBinder) : (zzdv) queryLocalInterface;
        }
