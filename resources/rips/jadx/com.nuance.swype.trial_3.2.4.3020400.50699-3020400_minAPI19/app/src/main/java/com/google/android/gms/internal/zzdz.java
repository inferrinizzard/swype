...
public interface zzdz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdz {
        ...
        /* loaded from: classes.dex */
        private static class C0071zza implements zzdz {
            ...
            @Override // com.google.android.gms.internal.zzdz
            public final String zzat(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
            ...
            @Override // com.google.android.gms.internal.zzdz
            public final zzdr zzau(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeCustomTemplateAd");
        ...
        public static zzdz zzad(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdz)) ? new C0071zza(iBinder) : (zzdz) queryLocalInterface;
        }
