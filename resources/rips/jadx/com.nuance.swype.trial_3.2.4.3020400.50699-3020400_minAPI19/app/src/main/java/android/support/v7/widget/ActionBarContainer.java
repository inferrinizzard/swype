...
public class ActionBarContainer extends FrameLayout {
    ...
    public void setTransitioning(boolean isTransitioning) {
        ...
        setDescendantFocusability(isTransitioning ? 393216 : HardKeyboardManager.META_META_RIGHT_ON);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView == null && View.MeasureSpec.getMode(heightMeasureSpec) == Integer.MIN_VALUE && this.mHeight >= 0) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, View.MeasureSpec.getSize(heightMeasureSpec)), Integers.STATUS_SUCCESS);
        }
