...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent {
    ...
    static /* synthetic */ boolean access$102$1cca4512(ActionBarOverlayLayout x0) {
        x0.mAnimatingForFling = false;
        return false;
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = OpenWnnEngineJAJP.FREQ_LEARN;
    ...
    private void init(Context context) {
        ...
        this.mFlingEstimator = ScrollerCompat.create(context, null);
    }
    ...
    public void setActionBarVisibilityCallback(ActionBarVisibilityCallback cb) {
        ...
        if (getWindowToken() != null && this.mLastSystemUiVisibility != 0) {
    ...
    private static boolean applyInsets$614d7dc0(View view, Rect insets, boolean bottom) {
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        boolean changed = applyInsets$614d7dc0(this.mActionBarTop, insets, false);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(maxWidth2 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), widthMeasureSpec, childState2), ViewCompat.resolveSizeAndState(Math.max(getPaddingTop() + getPaddingBottom() + maxHeight2, getSuggestedMinimumHeight()), heightMeasureSpec, childState2 << 16));
    }
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        this.mParentHelper.mNestedScrollAxes = axes;
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed) {
        ...
        this.mFlingEstimator.fling$69c647f5(0, (int) velocityY, 0, 0);
