...
public interface zzhp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhp {
        ...
        /* loaded from: classes.dex */
        private static class C0094zza implements zzhp {
        ...
        public static zzhp zzav(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhp)) ? new C0094zza(iBinder) : (zzhp) queryLocalInterface;
        }
