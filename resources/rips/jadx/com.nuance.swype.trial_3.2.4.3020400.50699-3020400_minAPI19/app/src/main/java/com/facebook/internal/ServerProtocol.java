...
public final class ServerProtocol {
    ...
    public static final Collection<String> errorsProxyAuthDisabled = Utility.unmodifiableCollection(ACScannerFacebook.FacebookApi.SINGLE_SIGN_ON_DISABLED, "AndroidAuthKillSwitchException");
