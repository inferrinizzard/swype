...
public interface IInAppBillingService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInAppBillingService {
        ...
        private static class Proxy implements IInAppBillingService {
            ...
            public final int isBillingSupported(int apiVersion, String packageName, String type) throws RemoteException {
            ...
            @Override // com.android.vending.billing.IInAppBillingService
            public final Bundle getSkuDetails(int apiVersion, String packageName, String type, Bundle skusBundle) throws RemoteException {
                Bundle _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            @Override // com.android.vending.billing.IInAppBillingService
            public final Bundle getBuyIntent(int apiVersion, String packageName, String sku, String type, String developerPayload) throws RemoteException {
                Bundle _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            @Override // com.android.vending.billing.IInAppBillingService
            public final Bundle getPurchases(int apiVersion, String packageName, String type, String continuationToken) throws RemoteException {
                Bundle _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            @Override // com.android.vending.billing.IInAppBillingService
            public final int consumePurchase(int apiVersion, String packageName, String purchaseToken) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken("com.android.vending.billing.IInAppBillingService");
