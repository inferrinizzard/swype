...
public class ProfilePictureView extends FrameLayout {
    ...
    private void sendImageRequest(boolean allowCachedResponse) {
        ImageRequest request = new ImageRequest.Builder(getContext(), ImageRequest.getProfilePictureUri(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new ImageRequest.Callback() { // from class: com.facebook.login.widget.ProfilePictureView.1
    ...
    private boolean updateImageQueryParameters() {
        ...
        boolean changed = (newWidthPx == this.queryWidth && newHeightPx == this.queryHeight) ? false : true;
