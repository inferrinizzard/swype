...
public class ViewPager extends ViewGroup {
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged$49113dbb(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapter != null) {
            if (this.mObserver == null) {
                this.mObserver = new PagerObserver(this, b);
            }
        ...
        if (this.mAdapterChangeListeners != null && !this.mAdapterChangeListeners.isEmpty()) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                this.mAdapterChangeListeners.get(i2).onAdapterChanged$49113dbb(oldAdapter, adapter);
            }
        }
    }
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        if (velocity2 > 0) {
            ...
            duration = (int) (((Math.abs(dx) / (this.mPageMargin + pageWidth)) + 1.0f) * 100.0f);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8 && (lp2 = (LayoutParams) child.getLayoutParams()) != null && lp2.isDecor) {
                ...
                int widthMode = Integers.STATUS_SUCCESS;
                int heightMode = Integers.STATUS_SUCCESS;
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        if (oldWidth > 0 && !this.mItems.isEmpty()) {
            ...
            int newOffsetPixels = (int) ((getScrollX() / oldWidthWithMargin) * widthWithMargin);
            scrollTo(newOffsetPixels, getScrollY());
            return;
        }
        ItemInfo ii = infoForPosition(this.mCurItem);
        int scrollPos = (int) ((ii != null ? Math.min(ii.offset, this.mLastOffset) : 0.0f) * ((width - getPaddingLeft()) - getPaddingRight()));
        ...
        switch (action & 255) {
            ...
            case 2:
                ...
                if (this.mIsBeingDragged) {
                    ...
                    float x3 = MotionEventCompat.getX(ev, activePointerIndex2);
                    needsInvalidate = performDrag(x3) | false;
                    break;
                }
                break;
            case 3:
            ...
            case 5:
                ...
                float x4 = MotionEventCompat.getX(ev, index);
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == 1 && this.mAdapter != null && this.mAdapter.getCount() > 1)) {
            if (!this.mLeftEdge.isFinished()) {
                ...
                needsInvalidate = this.mLeftEdge.draw(canvas) | false;
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        boolean metaStateHasModifiers$255f299;
        ...
        switch (event.getKeyCode()) {
            ...
            case 61:
                ...
                if (!KeyEventCompat.hasNoModifiers(event)) {
                    metaStateHasModifiers$255f299 = KeyEventCompat.IMPL.metaStateHasModifiers$255f299(event.getMetaState());
                    if (!metaStateHasModifiers$255f299) {
                        return false;
                    }
                    boolean handled3 = arrowScroll(1);
                    return handled3;
                }
                boolean handled4 = arrowScroll(2);
                return handled4;
            default:
                return false;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x00cc, code lost:            if (r14 != 2) goto L13;     */
    /*
    ...
    */
    public boolean arrowScroll(int r14) {
        ...
        Lb:
            ...
            android.view.View r4 = r8.findNextFocus(r13, r1, r14)
            if (r4 == 0) goto Lbe
            if (r4 == r1) goto Lbe
            if (r14 != r11) goto La2
            android.graphics.Rect r8 = r13.mTempRect
            android.graphics.Rect r8 = r13.getChildRectInPagerCoordinates(r8, r4)
            int r5 = r8.left
            android.graphics.Rect r8 = r13.mTempRect
            android.graphics.Rect r8 = r13.getChildRectInPagerCoordinates(r8, r1)
            int r0 = r8.left
            if (r1 == 0) goto L9d
            if (r5 < r0) goto L9d
            boolean r2 = r13.pageLeft()
        L32:
            if (r2 == 0) goto L3b
            int r8 = android.view.SoundEffectConstants.getContantForFocusDirection(r14)
        ...
        L80:
            ...
            java.lang.String r10 = "arrowScroll tried to find focus based on non-child current focused view "
            r9.<init>(r10)
    ...
    private class PagerObserver extends DataSetObserver {
        ...
        /* synthetic */ PagerObserver(ViewPager x0, byte b) {
            this();
        }
